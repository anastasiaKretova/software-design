...
public class EventSourcingTest {
    ...
    public void testEntryUsers() {
        system.managerService.newMember("A");
        system.managerService.newMember("B");
    ...
    public void testMembershipRenew() {
        ...
        assertTrue(system.managerService.getMembershipInfo(1)
                .contains(String.format("Membership ID: 1, owner ID: 1, valid from %s to %s", dateFormat.format(date), dateFormat.format(endDate))));
    ...
    public void testStatistics() {
        ...
        system.entryService.exitMemberAt(1, date);
        system.entryService.enterMemberAt(2, 2, date);
        system.entryService.exitMemberAt(2, new Date(date.getTime() + 1000 * 60 * 8));
        ...
        system.entryService.exitMemberAt(1, new Date(date.getTime() + 1000 * 60 * 13));
        system.entryService.enterMemberAt(1, 1, new Date(date.getTime() + 1000 * 60 * 1227));
        system.entryService.exitMemberAt(1, new Date(date.getTime() + 1000 * 60 * 1228));
